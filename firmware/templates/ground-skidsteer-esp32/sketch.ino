...
const int STATIC_CIDR = {{wifi.staticCidr}}; // valid 0..32
...
// ===== Calibration =====
const bool INVERT_LEFT_MOTOR = {{motor.invertLeft}};
const bool INVERT_RIGHT_MOTOR = {{motor.invertRight}};
const int LEFT_TRIM = {{motor.leftTrim}};
const int RIGHT_TRIM = {{motor.rightTrim}};
